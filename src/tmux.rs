...
pub use options::{
    ...
    PANE_STARTED_AT, PANE_STATUS, PANE_SUBAGENTS, PANE_TRANSCRIPT_PATH, PANE_WAIT_REASON,
    ...
    SIDEBAR_COLOR_AGENT_OPENCODE, SIDEBAR_COLOR_ALL, SIDEBAR_COLOR_ATTENTION_ACTION_BG,
    SIDEBAR_COLOR_ATTENTION_COMPLETED_BG, SIDEBAR_COLOR_BORDER, SIDEBAR_COLOR_BRANCH,
    ...
    SIDEBAR_WIDTH, clear_pane_option_if_value, get_all_global_options, get_option,
