...
/// that lights up the corresponding Sidebar card.
...
pub const SIDEBAR_COLOR_ATTENTION_ACTION_BG: &str = "@sidebar_color_attention_action_bg";
pub const SIDEBAR_COLOR_ATTENTION_COMPLETED_BG: &str = "@sidebar_color_attention_completed_bg";
